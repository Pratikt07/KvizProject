...
module.exports.completed = function(req, res) {
    ...
    db.quiz.update({ overall_timer: update_timer, quiz_present_date: present_date, quiz_pin: pin }, { where: { quiz_id: quiz_id } }).then(result => {}).catch(err => {
        console.log(err);
